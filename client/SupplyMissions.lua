...
function supplymissionbeginstage()
    ...
    repeat
        ...
        VORPcore.NotifyRightTip(_U('SupplyWagonMisisonBegin'), 4000)
        ...
        VORPcore.NotifyRightTip(_U('Grabbingsupplies'), 3000)
        ...
        VORPcore.NotifyRightTip(_U('Putsuppliesonwagon'), 4000)
...
function deliversupplies()
    ...
    VORPcore.NotifyRightTip(_U('DeliverSupplies'), 4000)
    ...
    repeat
        ...
        --Blip and Waypoint Setup
        local blip1 = BlipWaypoin(fillcoords.x, fillcoords.y, fillcoords.z, _U('DeliverSupplies'))
        ...
        VORPcore.NotifyRightTip(_U('GetSuppliesFromWagon'), 4000)
...
function supplymissionend()
    VORPcore.NotifyRightTip(_U('ReturnSupplyWagon'), 4000)

    --Blip and Waypoint Setup
    local blip1 = BlipWaypoin(OilWagonTable.WagonSpawnCoords.x, OilWagonTable.WagonSpawnCoords.y, OilWagonTable.WagonSpawnCoords.z, _U('ManagerBlip'))
